...
const Dashboard: React.FC = () => {
  ...
  const triggerVibration = (type: 'chat' | 'keepGoing' | 'scores') => {
    // Play KGC gong sound for therapeutic effect with haptic feedback
    createHapticFeedback(2000, true); // 2 second duration with sound enabled
    ...
    <Layout>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className={cn(
          ...
          isMobile && "pb-36" // Increased padding for smaller buttons moved down
        )}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Health Images Carousel - Taller for better visibility */}
              <Card className="overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-80 xs:h-96 sm:h-[28rem] md:h-[32rem] lg:h-[400px] xl:h-[500px]">
          ...
          {isMobile && (
            <div className="fixed bottom-8 left-4 right-4 z-40">
              <div className="grid grid-cols-2 gap-2 mb-2">
                ...
                {/* Keep Going Button - Smaller */}
                <KeepGoingButton
                  userId={patientToDisplayId || 2}
                  className={cn(
                    "h-24 shadow-lg text-sm opacity-85 hover:opacity-100",
                    keepGoingVibrating && "btn-vibrate"
                  )}
                />
              </div>
              
              {/* Daily Self-Scores - Full Width but Smaller */}
