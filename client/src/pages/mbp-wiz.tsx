  ...
  useEffect(() => {
    const fetchCarePlanDirectives = async () => {
      try {
        ...
        // Find the medication directive
        const medicationDirective = data.find((directive: any) => 
        ...
        if (medicationDirective) {
          // Display the doctor's exact Medication CPD text
          setCarePlanDirective(medicationDirective.directive);
        } else {
          setCarePlanDirective('Your doctor has not yet provided any Medication care plan directives. Please check back later.');
        }
      } catch (error) {
        ...
        setCarePlanDirective('Could not load Medication care plan directives. Please try again later.');
      } finally {
        setLoadingCPD(false);
      }
    };
