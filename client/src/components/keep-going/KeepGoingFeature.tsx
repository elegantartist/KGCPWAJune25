...
export const KeepGoingFeature: React.FC<KeepGoingFeatureProps> = ({ 
  ...
  const handleKeepGoingClick = () => {
    try {
      // Trigger haptic feedback with KGC gong sound (this is one of the 3 main buttons)
          ...
          >
            ...
            <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
              <div className={`relative mx-auto flex items-center justify-center ${
                isMobile ? 'w-full h-[80%]' : 'w-[95%] h-[85%]'
              }`}>
                {overlayImage ? (
                  <img 
                    src={overlayImage} 
                    ...
                    className={`w-auto h-auto object-contain transition-all duration-1000 ${
                      isMobile 
                        ? 'max-w-[80%] max-h-[75%] opacity-90'
                        : 'max-w-[85%] max-h-[80%] opacity-90'
                    }`}
                    style={{ 
                      mixBlendMode: 'screen',
                      filter: isMobile 
                  ...
                  <div className="text-center p-4 bg-black/40 backdrop-blur-sm rounded-2xl border-2 border-white/30 shadow-2xl">
                    <div 
