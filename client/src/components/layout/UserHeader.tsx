...
const UserHeader: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      <div className="flex items-center justify-between px-4 py-1 bg-white border-b">
        ...
        <div className="flex items-center gap-2">
          <Button 
            ...
            variant="outline" 
            size="sm" 
            className="text-[#2E8BC0] hover:text-[#2E8BC0] hover:bg-[#2E8BC0]/10 border-[#2E8BC0]/30 text-xs px-2 py-1 h-6"
          >
