...
export const KGC_FEATURES: KgcFeature[] = [
    ...
    { name: 'Health Snapshots', category: 'Health Tracking & Progress', longDescription: 'Provides visual progress summaries and adherence tracking of your daily self-scores.', shortDescription: '(visual progress summaries)' }
];
